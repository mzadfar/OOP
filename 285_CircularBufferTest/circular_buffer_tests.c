...
int circular_buffer_test_suite(void) {
  const struct CMUnitTest circular_buffer_tests[] = {
      cmocka_unit_test_setup_teardown(circular_buffer_init_test,
                                      circular_buffer_setup,
                                      circular_buffer_teardown),
      cmocka_unit_test_setup_teardown(circular_buf_put_get_test,
                                      circular_buffer_setup,
                                      circular_buffer_teardown),
      cmocka_unit_test_setup_teardown(circular_buf_try_put_get_test,
                                      circular_buffer_setup,
                                      circular_buffer_teardown),
      cmocka_unit_test_setup_teardown(circular_buffer_full_test,
                                      circular_buffer_setup,
                                      circular_buffer_teardown),
      cmocka_unit_test_setup_teardown(circular_buffer_empty_test,
                                      circular_buffer_setup,
                                      circular_buffer_teardown),
      cmocka_unit_test_setup_teardown(circular_buffer_get_more_than_stored_test,
                                      circular_buffer_setup,
                                      circular_buffer_teardown),
      cmocka_unit_test_setup_teardown(circular_buffer_peek_test,
                                      circular_buffer_setup,
                                      circular_buffer_teardown),
  };
