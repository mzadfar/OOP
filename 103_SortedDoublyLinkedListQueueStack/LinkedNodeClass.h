...
private:
  LinkedNodeClass
      *prevNode; /* Will point to the node that comes before this node in the
                    data structure. Will be NULL if this is the first node. */

  int nodeVal; /* The value contained within this node. */

  LinkedNodeClass
      *nextNode; /* Will point to the node that comes after this node in the
                    data structure. Will be NULL if this is the last node. */
