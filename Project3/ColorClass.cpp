...
//Purpose: develop program for member functions of color class 
...
//A public function to compare each RGB value in a pixel with the corresponding
//value from the input pixel, and get back a true boolean if they are equal 
bool ColorClass::compareColor(ColorClass &rhs)
{
  return ((inRed == rhs.inRed) && (inGreen == rhs.inGreen) && (inBlue == rhs.inBlue));
}

//A public function to read each RGB value in a pixel from a file and at 
//clip them if they are not in the range  
